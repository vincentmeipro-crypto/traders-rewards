...
const RULES: Array<{
...
}> = [
  {
    ...
    rules: [
      ...
      { rule_key: "reward_cap_1",          rule_value: 250,   enabled: true,
        description: "Plafond Reward #1 — 25K : 250 USD. (1 % de 25 000)" },
      { rule_key: "reward_cap_2",          rule_value: 375,   enabled: true,
        description: "Plafond Reward #2 — 25K : 375 USD. (1,5 % de 25 000)" },
      { rule_key: "reward_cap_3",          rule_value: 500,   enabled: true,
        description: "Plafond Reward #3 — 25K : 500 USD. (2 % de 25 000)" },
      { rule_key: "reward_cap_4",          rule_value: 625,   enabled: true,
        description: "Plafond Reward #4 — 25K : 625 USD. (2,5 % de 25 000)" },
      { rule_key: "reward_cap_5",          rule_value: 750,   enabled: true,
        description: "Plafond Reward #5 — 25K : 750 USD. (3 % de 25 000)" },
    ],
  },
  {
    slug: "rewards-50k",
    rules: [
      ...
      { rule_key: "reward_cap_1",          rule_value: 500,   enabled: true,
        description: "Plafond Reward #1 — 50K : 500 USD. (1 % de 50 000)" },
      { rule_key: "reward_cap_2",          rule_value: 750,   enabled: true,
        description: "Plafond Reward #2 — 50K : 750 USD. (1,5 % de 50 000)" },
      { rule_key: "reward_cap_3",          rule_value: 1000,  enabled: true,
        description: "Plafond Reward #3 — 50K : 1 000 USD. (2 % de 50 000)" },
      { rule_key: "reward_cap_4",          rule_value: 1250,  enabled: true,
        description: "Plafond Reward #4 — 50K : 1 250 USD. (2,5 % de 50 000)" },
      { rule_key: "reward_cap_5",          rule_value: 1500,  enabled: true,
        description: "Plafond Reward #5 — 50K : 1 500 USD. (3 % de 50 000)" },
    ],
  },
  {
    slug: "rewards-100k",
    rules: [
      ...
      { rule_key: "reward_cap_1",          rule_value: 1000,  enabled: true,
        description: "Plafond Reward #1 — 100K : 1 000 USD. (1 % de 100 000)" },
      { rule_key: "reward_cap_2",          rule_value: 1500,  enabled: true,
        description: "Plafond Reward #2 — 100K : 1 500 USD. (1,5 % de 100 000)" },
      { rule_key: "reward_cap_3",          rule_value: 2000,  enabled: true,
        description: "Plafond Reward #3 — 100K : 2 000 USD. (2 % de 100 000)" },
      { rule_key: "reward_cap_4",          rule_value: 2500,  enabled: true,
        description: "Plafond Reward #4 — 100K : 2 500 USD. (2,5 % de 100 000)" },
      { rule_key: "reward_cap_5",          rule_value: 3000,  enabled: true,
        description: "Plafond Reward #5 — 100K : 3 000 USD. (3 % de 100 000)" },
    ],
  },
];

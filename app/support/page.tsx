...
export default function SupportPage() {
  ...
  const lbl: React.CSSProperties = {
    color: "#888", fontSize: 12, fontWeight: 700, letterSpacing: "0.8px",
    textTransform: "uppercase", display: "block", marginBottom: 8,
  };

  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#070707", color: "#fff" }}>
      <Navbar />
      <div style={{ maxWidth: 600, margin: "0 auto", padding: "120px 24px 80px" }}>

        <div style={{ textAlign: "center", marginBottom: 48 }}>
          <h1 style={{ fontSize: 36, fontWeight: 900, marginBottom: 12, letterSpacing: "-1px" }}>
        ...
        {success ? (
          <div style={{ textAlign: "center", backgroundColor: "#0f0f0f", border: "1px solid #1e1e1e", borderRadius: 20, padding: "48px 40px" }}>
            <div style={{ fontSize: 48, marginBottom: 20 }}>✅</div>
            <h2 style={{ fontSize: 22, fontWeight: 800, marginBottom: 12 }}>Message envoyé !</h2>
            <p style={{ color: "#555", fontSize: 15, lineHeight: 1.7, marginBottom: 28 }}>
              Notre équipe vous répondra dans les plus brefs délais à <strong style={{ color: "#C9A84C" }}>{email || "votre adresse email"}</strong>.
            </p>
            <button onClick={() => setSuccess(false)}
              style={{ background: "none", border: "1px solid #333", borderRadius: 10, padding: "12px 28px", color: "#888", fontSize: 14, cursor: "pointer" }}>
              Envoyer un autre message
            </button>
          </div>
        ) : (
          <form onSubmit={handleSubmit} style={{ backgroundColor: "#0f0f0f", border: "1px solid #1e1e1e", borderRadius: 20, padding: "40px 36px", display: "flex", flexDirection: "column", gap: 20 }}>
            ...
            <p style={{ textAlign: "center", color: "#444", fontSize: 13, margin: 0 }}>
              ...
              <a href="mailto:support@elysium-rewards.com" style={{ color: "#C9A84C", textDecoration: "none" }}>

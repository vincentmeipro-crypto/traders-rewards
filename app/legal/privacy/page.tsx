  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#070707", color: "#fff", fontFamily: "Inter, sans-serif" }}>
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "80px 24px" }}>
        <a href="/" style={{ color: "#69C5FD", fontSize: 13, textDecoration: "none", display: "block", marginBottom: 40 }}>← Back to Home</a>
        ...
        {[
          ...
          },
          {
            ...
            content: `Under GDPR, you have the right to: Access your personal data, Correct inaccurate data, Request deletion of your data ("right to be forgotten"), Restrict processing of your data, Data portability, Object to processing. To exercise these rights, contact us at contact@traders-rewards.eu.`
          },
          {
            title: "8. Cookies",
          ...
          <div key={i} style={{ marginBottom: 40 }}>
            <h2 style={{ fontSize: 18, fontWeight: 700, color: "#69C5FD", marginBottom: 12 }}>{section.title}</h2>

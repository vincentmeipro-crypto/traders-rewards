  ...
  const sections = [
    ...
    },
    {
      ...
      content: [
        ...
        "Le Compte Reward requiert d'atteindre le seuil Safety Net + cap du niveau demandé, au moins cinq (5) journées qualifiantes, une consistance maximale de 50% et ne comporte pas de limite de durée.",

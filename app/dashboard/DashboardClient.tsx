          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "1fr 1fr", gap: 16 }}>
              {[
                ...
                { title: isFr ? "Drawdown journalier" : "Daily Drawdown", desc: isFr ? "Votre compte ne peut pas perdre plus de 5% de sa valeur en une journée (2 Étapes) ou 8% (1 Étape)." : "Your account cannot lose more than 5% of its value in a single day (2-Step) or 8% (1-Step).", icon: <TrendingDown size={20} color="#1565C0" /> },

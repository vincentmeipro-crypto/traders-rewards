...
const TICKET_STATUS: Record<string, { fr: string; en: string; color: string; bg: string }> = {
  new:      { fr: "Nouveau",  en: "New",         color: "#3B82F6", bg: "rgba(59,130,246,0.12)" },
...
const CONV_STATUS: Record<string, { fr: string; en: string; color: string }> = {
  ...
  open:            { fr: "En cours",                en: "In progress",        color: "#3B82F6" },
        ...
        {(["tickets", "chat"] as SupportSubTab[]).map(t => (
          <button
            ...
            style={{
              ...
              backgroundColor: subTab === t ? "#3B82F6" : "transparent",
          ...
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 16, flexWrap: "wrap", gap: 10 }}>
            ...
            {!showForm && !selectedTicket && (
              <button
                ...
                onMouseOver={e => { e.currentTarget.style.backgroundColor = "rgba(59,130,246,0.18)"; }}
                  ...
                  <div style={{ display: "flex", gap: 10, justifyContent: "flex-end" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        borderRadius:    9,
                        border:          "none",
                        backgroundColor: formSending ? "rgba(59,130,246,0.5)" : "#3B82F6",
                        color:           "#ffffff",
                        fontSize:        13,
                        fontWeight:      700,
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                  {tickets.map(t => (
                    <button
                      ...
                      onMouseOver={e => { e.currentTarget.style.backgroundColor = "rgba(255,255,255,0.055)"; e.currentTarget.style.borderColor = "rgba(59,130,246,0.25)"; }}
                  ...
                  <div style={{
                    ...
                    {lastMsg && (
                      <div style={{
                        ...
                        borderRadius:    9,
                        marginBottom:    16,
                        borderLeft:      `3px solid ${lastMsg.sender_type === "admin" ? "#3B82F6" : "rgba(255,255,255,0.15)"}`,
                      }}>

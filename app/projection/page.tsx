      ...
      <div style={{ maxWidth: 980, margin: "0 auto" }}>
        ...
        <div style={{ background: "linear-gradient(135deg, #1565C0 0%, #1a2f5e 100%)", borderRadius: 20, padding: "40px 48px", marginBottom: 24, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
            <img src="/logo-nom-noir.png" alt="Traders Rewards" style={{ height: 64, width: "auto", filter: "brightness(10)" }} />
            <div>
          ...
          <div style={{ textAlign: "right" }}>
            ...
            <div style={{ fontSize: 16, fontWeight: 600, color: "#69C5FD", letterSpacing: "2px", textTransform: "uppercase" }}>Investisseur — Confidentiel</div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 14 }}>
              {[
                ...
                <div key={i} style={{ background: "rgba(255,255,255,0.12)", borderRadius: 12, padding: "18px 14px", textAlign: "center", border: "1px solid rgba(255,255,255,0.15)" }}>
                  <div style={{ fontSize: 30, fontWeight: 900, color: "#69C5FD", lineHeight: 1 }}>{s.value}</div>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "32px 40px", marginBottom: 20, border: "2px solid #69C5FD", boxShadow: "0 4px 24px rgba(201,168,76,0.1)" }}>
          <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#fdf8ee", borderRadius: 100, padding: "5px 14px", marginBottom: 18 }}>
            <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#69C5FD", display: "inline-block" }} />
            <span style={{ color: "#69C5FD", fontSize: 10, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase" }}>Analyse stratégique</span>
          </div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
            {[
              ...
              { label: "Objectif Y2 — France + EU",        value: "500 / mois", sub: "Réaliste 12–18 mois", color: "#69C5FD" },
        ...
        <div style={{ background: "linear-gradient(135deg, #1565C0, #1a2f5e)", borderRadius: 20, padding: "32px 40px", marginBottom: 20 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 16 }}>
            {[
              { invest: "5 000 €", parts: "5%", color: "#69C5FD", sub: "Ticket d'entrée" },
        ...
        {([
          { pct: "5%", invest: "5 000 €", divRate: 0.05,
            ...
            bilan: [
              ...
              { label: "1er versement (S1)",       value: "6 186 €",  color: "#69C5FD" },
              { label: "Dividendes cumulés 3 ans", value: "52 890 €", color: "#1B4FD8" },
              { label: "ROI total 3 ans",          value: "1 058 %",  color: "#69C5FD" },
            ],
          },
          ...
          <div key={ti} style={{ background: "#fff", borderRadius: 20, padding: "32px 40px", marginBottom: 20, border: "1px solid #e0eaff", boxShadow: "0 4px 24px rgba(21,101,192,0.07)" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: ti === 0 ? "#fdf8ee" : "#f0f4ff", borderRadius: 100, padding: "5px 14px", marginBottom: 18 }}>
              <span style={{ width: 6, height: 6, borderRadius: "50%", background: ti === 0 ? "#69C5FD" : "#1B4FD8", display: "inline-block" }} />
              <span style={{ color: ti === 0 ? "#69C5FD" : "#1B4FD8", fontSize: 10, fontWeight: 700, letterSpacing: "2px", textTransform: "uppercase" }}>Palier {ti + 1} — {tier.invest} / {tier.pct} des parts</span>
            </div>
            ...
            <div style={{ borderRadius: 12, overflow: "hidden", border: "1px solid #e0eaff", marginBottom: 16 }}>
              ...
              {tier.rows.map((row, i) => (
                <div key={i} style={{ display: "grid", gridTemplateColumns: "2fr 1.2fr 1.2fr 1.2fr 1fr 1.2fr 1fr", padding: "11px 16px", gap: 6, borderBottom: i < 4 ? "1px solid #e8f0ff" : "none", background: (row as any).bold ? "#eef5ff" : (i % 2 === 0 ? "#fff" : "#f8faff") }}>
                  ...
                  <div style={{ fontSize: 12, fontWeight: 800, color: ti === 0 ? "#69C5FD" : "#1B4FD8" }}>{row.div}</div>
                </div>
              ))}
            </div>

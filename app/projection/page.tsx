  ...
  return (
    <div style={{ fontFamily: "'Inter', system-ui, sans-serif", backgroundColor: "#f8faff", minHeight: "100vh", padding: "40px 24px", color: "#0D1B3E" }}>
      ...
      <div style={{ maxWidth: 980, margin: "0 auto" }}>
        ...
        {/* HEADER */}
        <div style={{ background: "linear-gradient(135deg, #0D1B3E 0%, #1a2f5e 100%)", borderRadius: 20, padding: "40px 48px", marginBottom: 24, display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 24 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "32px 40px", marginBottom: 20, border: "1px solid #e0eaff", boxShadow: "0 4px 24px rgba(21,101,192,0.07)" }}>
          ...
          <h2 style={{ fontSize: 20, fontWeight: 800, color: "#0D1B3E", margin: "0 0 4px 0" }}>Marché France & Europe — Traders particuliers</h2>
            ...
            {[
              ...
              <div key={i} style={{ background: "#f8faff", borderRadius: 12, padding: "18px 20px", border: "1px solid #e0eaff" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 14 }}>
                  ...
                  <span style={{ fontWeight: 800, fontSize: 15, color: "#0D1B3E" }}>{col.title}</span>
                </div>
                {col.rows.map((r, j) => (
          ...
          <div style={{ background: "linear-gradient(135deg, #f0f4ff, #e8f0ff)", borderRadius: 10, padding: "14px 18px", border: "1px solid #c5d5f5" }}>
            <p style={{ margin: 0, fontSize: 13, color: "#0D1B3E", fontWeight: 600 }}>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "32px 40px", marginBottom: 20, border: "2px solid #C9A84C", boxShadow: "0 4px 24px rgba(201,168,76,0.1)" }}>
          ...
          <h2 style={{ fontSize: 20, fontWeight: 800, color: "#0D1B3E", margin: "0 0 18px 0" }}>Synthèse — Objectif & réalisme de marché</h2>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 16 }}>
            <div style={{ background: "#f8faff", borderRadius: 12, padding: "18px", border: "1px solid #e0eaff" }}>
              ...
              <div style={{ fontSize: 13, color: "#4a5568", lineHeight: 1.8 }}>
                ...
                <strong style={{ color: "#0D1B3E", fontSize: 14 }}>= 500 challenges / mois</strong>
              </div>
        ...
        <div style={{ background: "#fff", borderRadius: 20, padding: "32px 40px", marginBottom: 20, border: "1px solid #e0eaff", boxShadow: "0 4px 24px rgba(21,101,192,0.07)" }}>
          ...
          <h2 style={{ fontSize: 20, fontWeight: 800, color: "#0D1B3E", margin: "0 0 18px 0" }}>Chiffres clés de rentabilité</h2>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 9 }}>
            {[
              ...
              <div key={i} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "13px 16px", background: row.hi ? "linear-gradient(135deg, #f0f4ff, #e8f2ff)" : "#f8faff", borderRadius: 10, border: `1px solid ${row.hi ? "#c5d5f5" : "#eef2fa"}` }}>
                ...
                <span style={{ fontSize: 13, fontWeight: 800, color: row.hi ? "#1B4FD8" : "#0D1B3E", whiteSpace: "nowrap", marginLeft: 12 }}>{row.value}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        {/* OFFRES */}
        <div style={{ background: "linear-gradient(135deg, #0D1B3E, #1a2f5e)", borderRadius: 20, padding: "32px 40px", marginBottom: 20 }}>
        ...
        {([
          ...
          <div key={ti} style={{ background: "#fff", borderRadius: 20, padding: "32px 40px", marginBottom: 20, border: "1px solid #e0eaff", boxShadow: "0 4px 24px rgba(21,101,192,0.07)" }}>
            ...
            <h2 style={{ fontSize: 19, fontWeight: 800, color: "#0D1B3E", margin: "0 0 18px 0" }}>Projection — {tier.pct} des dividendes</h2>

            <div style={{ borderRadius: 12, overflow: "hidden", border: "1px solid #e0eaff", marginBottom: 16 }}>
              <div style={{ display: "grid", gridTemplateColumns: "2fr 1.2fr 1.2fr 1.2fr 1fr 1.2fr 1fr", background: "#0D1B3E", padding: "11px 16px", gap: 6 }}>
              ...
              {tier.rows.map((row, i) => (
                <div key={i} style={{ display: "grid", gridTemplateColumns: "2fr 1.2fr 1.2fr 1.2fr 1fr 1.2fr 1fr", padding: "11px 16px", gap: 6, borderBottom: i < 4 ? "1px solid #e8f0ff" : "none", background: (row as any).bold ? "#eef5ff" : (i % 2 === 0 ? "#fff" : "#f8faff") }}>
                  <div style={{ fontSize: 12, fontWeight: (row as any).bold ? 800 : 500, color: "#0D1B3E" }}>{row.sem}</div>

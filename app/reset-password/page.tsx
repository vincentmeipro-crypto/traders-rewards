                ...
                <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      <input type={showPassword ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} placeholder="Min. 8 caractères" required style={{ ...inp, paddingRight: 48 }} onFocus={e => (e.target.style.borderColor = "#C9A84C")} onBlur={e => (e.target.style.borderColor = "#222")} />
                  ...
                  <div>
                    ...
                    <div style={{ position: "relative" }}>
                      <input type={showConfirm ? "text" : "password"} value={confirm} onChange={e => setConfirm(e.target.value)} placeholder="Répéter le mot de passe" required style={{ ...inp, paddingRight: 48, borderColor: confirm ? (confirm === password ? "#22c55e" : "#ef4444") : "#222" }} />

  ...
  if (error) return (
    <div style={{ minHeight: "100vh", backgroundColor: "#070707", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div style={{ backgroundColor: "#0f0f0f", border: "1px solid #ef4444", borderRadius: 12, padding: 32, maxWidth: 500 }}>
        ...
        <a href="/dashboard" style={{ display: "block", marginTop: 20, color: "#ffffff", fontSize: 13 }}>← Dashboard</a>
      </div>
    </div>
  );
          ...
          <div style={{ display: "flex", gap: 4 }}>
            {(["challenges", "promos"] as const).map(t => (
              <button key={t} onClick={() => setTab(t)}
                style={{ backgroundColor: tab === t ? "#ffffff" : "transparent", color: tab === t ? "#000" : "#555", border: `1px solid ${tab === t ? "#ffffff" : "#222"}`, borderRadius: 8, padding: "6px 16px", fontSize: 13, fontWeight: 700, cursor: "pointer", textTransform: "capitalize" }}>
        ...
        {tab === "challenges" && (
          <>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: 16, marginBottom: 32 }}>
              {[
                { label: "Total Revenue", value: `€${totalRevenue.toLocaleString()}`, color: "#ffffff" },
                ...
                <table style={{ width: "100%", borderCollapse: "collapse", fontSize: 13 }}>
                  ...
                  <tbody>
                    {filtered.map(c => (<>
                        ...
                        <tr key={`${c.id}-icm`} style={{ backgroundColor: "rgba(201,168,76,0.03)" }}>
                          <td colSpan={14} style={{ padding: "10px 16px" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 8, flexWrap: "wrap" }}>
                              <span style={{ color: "#ffffff", fontSize: 11, fontWeight: 700, textTransform: "uppercase", letterSpacing: "1px", marginRight: 4 }}>IC Markets →</span>
                              {[
                      ...
                      <tr key={c.id} style={{ borderBottom: "1px solid #111" }}>
                        ...
                        <td style={{ padding: "14px 16px" }}>
                          {editing === c.id ? (
                            ...
                            <span style={{ color: c.phase === "funded" ? "#3b82f6" : c.phase === "phase2" ? "#ffffff" : "#888", fontWeight: 600, fontSize: 12 }}>{c.phase}</span>
                          )}
                        </td>
                        <td style={{ padding: "14px 16px" }}>
                          {editing === c.id ? (
                        ...
                        <td style={{ padding: "14px 16px" }}>
                          {editing === c.id ? (
                            <input type="text" placeholder="Password" value={editData.ctrader_password ?? c.ctrader_password ?? ""}
                              ...
                              style={{ backgroundColor: "#1a1a1a", border: "1px solid #ffffff55", borderRadius: 6, padding: "4px 8px", color: "#fff", fontSize: 12, width: 100 }} />
                          ) : (
                        ...
                        <td style={{ padding: "14px 16px" }}>
                          {editing === c.id ? (
                            <input type="text" placeholder="ex: ICMarkets-Demo01" value={editData.server ?? c.server ?? ""}
                              ...
                              style={{ backgroundColor: "#1a1a1a", border: "1px solid #ffffff55", borderRadius: 6, padding: "4px 8px", color: "#fff", fontSize: 12, width: 140 }} />
                          ) : (
                        ...
                        <td style={{ padding: "14px 16px" }}>
                          {editing !== c.id && (
                            <div style={{ display: "flex", gap: 6 }}>
                              <button onClick={() => { setEditing(c.id); setEditData({}); }} style={{ backgroundColor: "#1a1a1a", color: "#ffffff", border: "1px solid #ffffff33", borderRadius: 6, padding: "5px 12px", fontSize: 12, cursor: "pointer" }}>Edit</button>
                      ...
                      {editing === c.id && (
                        <tr key={`${c.id}-save`}>
                          <td colSpan={13} style={{ padding: "10px 16px", backgroundColor: "rgba(201,168,76,0.08)", borderBottom: "2px solid #ffffff33" }}>
                            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                              <span style={{ color: "#ffffff", fontSize: 12, fontWeight: 700 }}>✏️ En cours d&apos;édition</span>

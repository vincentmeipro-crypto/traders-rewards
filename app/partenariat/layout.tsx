...
export const metadata: Metadata = {
  ...
  description:
    "Rejoignez le programme d'affiliation Traders Rewards et gagnez jusqu'à 20% de commission. Partagez votre lien, recommandez notre propfirm française et touchez vos commissions chaque semaine.",
  keywords: [
    "affiliation propfirm",
    "partenariat trading",
  ...
  openGraph: {
    ...
    description:
      "Partagez votre lien de parrainage et gagnez jusqu'à 20% de commission sur chaque challenge vendu. Programme d'affiliation de la propfirm française Traders Rewards.",

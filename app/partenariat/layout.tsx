...
export const metadata: Metadata = {
  ...
  description:
    "Rejoignez le programme d'affiliation Traders Rewards et gagnez jusqu'à 20% de commission. Partagez votre lien, recommandez notre programme éducatif de trading et touchez vos commissions chaque semaine.",
  keywords: [
    "affiliation programme trading",
    "partenariat trading",
    "programme affiliation trading france",
    "gagner argent trading affiliation",
    "commission programme trading",
    "programme partenaire traders rewards",
  ],
  openGraph: {
    title: "Programme Partenariat — Traders Rewards | Jusqu'à 20% de commission",
    description:
      "Partagez votre lien de parrainage et gagnez jusqu'à 20% de commission sur chaque challenge vendu. Programme d'affiliation de Traders Rewards.",

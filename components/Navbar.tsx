          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, flex: isMobile ? "0 0 auto" : undefined }}>
            {isMobile ? (
              ...
              <a href="/" style={{ display: "flex", alignItems: "center", justifyContent: "center", textDecoration: "none", height: 60 }}>
                <img src="/logo-blanc-transparent.png" alt="Traders Rewards" style={{ height: 59, width: "auto", objectFit: "contain", marginLeft: -10, transform: "translateY(4px)" }} />
              </a>
            ) : (
              /* Desktop gauche : logo + drapeaux */
              <>
                <a href="/" style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
                  <img src="/logo-blanc-transparent.png" alt="Traders Rewards" style={{ height: 97, width: "auto", objectFit: "contain", marginLeft: -10, transform: "translateY(6px)" }} />
                </a>

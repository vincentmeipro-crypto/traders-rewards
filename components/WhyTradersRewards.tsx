...
//  Design : metric-led · palette #000/#111/blanc/gris/#D4A843 (or rose)
  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" style={{
        ...
        borderRadius:  "50%",
        background:    "radial-gradient(ellipse, rgba(184,135,70,0.05), transparent 65%)",
        filter:        "blur(24px)",
        pointerEvents: "none",
      }} />

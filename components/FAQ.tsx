...
const faqData = {
  ...
  fr: [
    ...
    // 06
    {
      ...
      a: "Le Compte Reward est votre compte long terme, accessible après avoir validé votre Challenge et réglé les frais d'activation. Vous devez atteindre le seuil Safety Net + cap du niveau demandé (ex. Reward #1 : 26 350 $ sur le 25K / 52 600 $ sur le 50K / 104 100 $ sur le 100K) avec au minimum 5 journées qualifiantes. La règle de consistance exige que votre meilleure journée représente moins de 50 % de votre profit total. Vous disposez d'un temps illimité.",
    },
    // 07
    {
  ...
  es: [
    ...
    // 06
    {
      ...
      a: "El Compte Reward es tu cuenta a largo plazo, accesible tras validar tu Challenge y abonar los gastos de activación. Debes alcanzar el umbral Safety Net + tope del nivel (ej. Reward #1: 26 350 $ en el 25K / 52 600 $ en el 50K / 104 100 $ en el 100K) con un mínimo de 5 días calificados. La consistencia máxima es del 50 % y dispones de tiempo ilimitado.",
    },
    // 07
    {
  ...
  pt: [
    ...
    { q: "O que é a Compte Reward?", a: "A Compte Reward é a conta a longo prazo, acessível após validar o Challenge e pagar a taxa de ativação. Deve atingir o limiar Safety Net + tope do nível (ex. Reward #1: 26 350 $ no 25K / 52 600 $ no 50K / 104 100 $ no 100K) com pelo menos 5 dias qualificados. Consistência máxima: 50 %. Tempo ilimitado." },
  ...
  de: [
    ...
    { q: "Was ist das Compte Reward?", a: "Das Compte Reward ist Ihr Langzeitkonto nach bestandener Challenge. Ziel: Safety Net + Cap des Levels (Reward #1: 26 350 $ beim 25K / 52 600 $ beim 50K / 104 100 $ beim 100K) mit mindestens 5 qualifizierenden Tagen. Maximale Konsistenz: 50 %. Unbegrenzte Zeit." },
  ...
  tr: [
    ...
    { q: "Compte Reward nedir?", a: "Compte Reward, Challenge'ı geçtikten ve aktivasyon ücretini ödedikten sonra erişilen uzun vadeli hesaptır. İlk Reward için Safety Net + seviye tavan eşiğine (Reward #1: 25K: 26 350 $, 50K: 52 600 $, 100K: 104 100 $) minimum 5 nitelikli gün ile ulaşmanız gerekir. Maksimum tutarlılık: %50. Süre sınırsızdır." },
  ...
  ar: [
    ...
    { q: "ما هو Compte Reward؟", a: "Compte Reward هو حسابك طويل الأمد، متاح بعد إتمام Challenge ودفع رسوم التفعيل. يجب الوصول إلى عتبة Safety Net + تابع المستوى (Reward #1: 26 350 $ للـ25K / 52 600 $ للـ50K / 104 100 $ للـ100K) مع 5 أيام مؤهلة على الأقل. الاتساق الأقصى 50 %. الوقت غير محدود." },

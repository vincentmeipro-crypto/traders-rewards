...
const faqData = {
  en: [
    { q: "How do I get started?", a: "Choose your challenge (2-Step or 1-Step), select your account size ($10K to $200K, up to $400K cumulative on Reward accounts), complete payment, and receive your trading account credentials instantly by email." },
  ...
  es: [
    { q: "¿Cómo empezar?", a: "Elige tu challenge (2-Step o 1-Step), selecciona el tamaño de cuenta ($10K a $200K, hasta $400K acumulado en cuentas Reward), realiza el pago y recibe tus credenciales al instante por email." },
  ...
  pt: [
    { q: "Como começar?", a: "Escolha seu challenge (2-Step ou 1-Step), selecione o tamanho da conta ($10K a $200K, até $400K acumulado em contas Reward), efetue o pagamento e receba suas credenciais instantaneamente por email." },
  ...
  de: [
    { q: "Wie starte ich?", a: "Wähle deine Challenge (2-Step oder 1-Step), wähle die Kontogröße ($10K bis $200K, bis zu $400K kumuliert auf Reward-Konten), zahle und erhalte deine Zugangsdaten sofort per E-Mail." },
  ...
  tr: [
    { q: "Nasıl başlarım?", a: "Challenge'ınızı seçin (2-Step veya 1-Step), hesap boyutunu seçin ($10K-$200K, Reward hesaplarda kümülatif $400K'ya kadar), ödeme yapın ve kimlik bilgilerinizi anında email ile alın." },
  ...
  ar: [
    { q: "كيف أبدأ؟", a: "اختر تحديك (2-Step أو 1-Step)، حدد حجم حسابك ($10K إلى $200K، حتى $400K متراكم في حسابات Reward)، أكمل الدفع واستلم بيانات الدخول فوراً عبر البريد الإلكتروني." },

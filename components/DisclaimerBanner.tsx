...
export default function DisclaimerBanner() {
  ...
  return (
    <div className="disclaimer-banner" role="status" style={{
      ...
      zIndex: 999,
      background: "linear-gradient(180deg, #3a2c16 0%, #241a0e 100%)",
      borderTop: "2px solid #E6C57E",
      borderBottom: "1px solid rgba(214,173,99,0.55)",
      boxShadow: "inset 0 1px 0 rgba(242,215,154,0.35)",
      padding: "14px 24px",
      display: "flex",
      alignItems: "center",

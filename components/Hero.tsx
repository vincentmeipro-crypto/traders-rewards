      ...
      <section style={{
        ...
        {isMobile ? (
          <div style={{ width: "100%", display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", padding: "20px 24px 0px" }}>
            <div className="hero-animate-1" style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 14 }}>
              <img src="https://flagcdn.com/40x30/fr.png" alt="FR" style={{ width: 18, height: 14, borderRadius: 2, objectFit: "cover" }} />
              <img src="https://flagcdn.com/40x30/eu.png" alt="EU" style={{ width: 18, height: 14, borderRadius: 2, objectFit: "cover" }} />

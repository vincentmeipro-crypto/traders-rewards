    ...
    <section id="how-it-works" className="how-section">
      ...
      <style jsx>{`
        ...
        .how-section::before {
          ...
          border-radius: 50%;
          background: radial-gradient(ellipse, rgba(183,110,121, 0.055), transparent 68%);
          filter: blur(14px);
          pointer-events: none;
        }
        ...
        .how-card:hover {
          ...
          box-shadow: 0 36px 86px rgba(0, 0, 0, 0.88), 0 0 25px rgba(183,110,121, 0.08), 0 14px 34px rgba(0, 0, 0, 0.62), inset 0 1px 0 rgba(255, 255, 255, 0.045);
        }
        ...
        .how-card-featured {
          ...
          box-shadow: 0 38px 94px rgba(0, 0, 0, 0.9), 0 0 38px rgba(183,110,121, 0.14), 0 14px 36px rgba(0, 0, 0, 0.66), inset 0 1px 0 rgba(255, 255, 255, 0.055);
        }

        .how-card-featured:hover {
          transform: translateY(-11px);
          border-color: rgba(183,110,121, 0.56);
          box-shadow: 0 42px 102px rgba(0, 0, 0, 0.92), 0 0 44px rgba(183,110,121, 0.18), 0 16px 38px rgba(0, 0, 0, 0.7), inset 0 1px 0 rgba(255, 255, 255, 0.06);
        }
        ...
        .how-card-glow {
          ...
          background: radial-gradient(circle at 50% 0%, rgba(183,110,121, 0.055), transparent 49%);
          pointer-events: none;
        }

        .how-card-featured .how-card-glow {
          background: radial-gradient(circle at 50% 0%, rgba(183,110,121, 0.15), transparent 54%);
        }
        ...
        .how-card-featured .how-icon {
          ...
          color: #1A0808;
          background: linear-gradient(145deg, #F1D0C8, #D8A39D);
          box-shadow: 0 10px 28px rgba(0, 0, 0, 0.45), 0 0 24px rgba(183,110,121, 0.22);
        }

...
const items = [
  ...
  { en: "🏆 No time limit · Unlimited trading days", fr: "🏆 Aucune limite de temps · Jours de trading illimités" },
  { en: "💰 Up to $200,000 in simulated capital — Scale to $400,000", fr: "💰 Jusqu'à 200 000$ de capital simulé — Évoluez jusqu'à 400 000$" },
];
    ...
    <div style={{
      ...
      <button
        ...
        style={{
          ...
          color: "rgba(255,255,255,0.7)", padding: "0 12px",

...
export default function TopTraders() {
  ...
  return (
    <section style={{ padding: "clamp(20px, 5vw, 100px) 0 0", overflow: "hidden", background: "transparent", position: "relative" }}>
      ...
      {/* Fond femme trader */}
      <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/HOMME-TRADER-GAUCHE.png')", backgroundSize: "cover", backgroundPosition: isMobile ? "center top" : "left center", opacity: isMobile ? 0.25 : 0.6, pointerEvents: "none", zIndex: 0 }} />

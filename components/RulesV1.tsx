      ...
      <div style={{ maxWidth: compact ? "none" : 1500, margin: "0 auto" }}>
        ...
        >
          {cards.map((card, index) => (
            ...
            {index === 1 && (
              <div aria-hidden="true" style={{ display: "flex", alignItems: "center", justifyContent: "center", minWidth: 0, height: "auto", minHeight: 0, overflow: "visible", position: "relative", zIndex: 1, marginTop: isMobile ? "-62px" : "0", marginBottom: isMobile ? "-16px" : "0" }}>

  ...
  return (
    <footer style={{ borderTop: "1px solid #2A2A38", padding: "60px 24px 40px" }}>
      <div style={{ maxWidth: 1200, margin: "0 auto" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1.5fr 1fr 1fr 1fr", gap: 40, marginBottom: 60, alignItems: "start" }}>

          {/* Logo + tagline */}
          <div>
            <img src="/logo-elysium-rewards.png" alt="Elysium Rewards" style={{ height: 64, width: "auto", objectFit: "contain", marginBottom: 16, display: "block" }} />

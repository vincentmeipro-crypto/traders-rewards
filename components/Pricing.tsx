...
const accounts = [
  ...
  { size: "$25,000",  id: "25k",  label: "25K",  price2: "€199", price1: "€169", promo2: "€99",  promo1: "€84",  popular: false, premium: false, confirmed: false, beginner: false, reward: "~€1,200" },
  ...
  const PriceCard = ({ acc, compact }: { acc: typeof displayAccounts[0]; compact: boolean }) => {
    ...
    return (
      <div style={{
        ...
        {(acc.popular || acc.premium || acc.confirmed || acc.beginner) && (
          <div style={{
            position: "absolute", top: 0, right: 0,
            background: acc.popular ? "#16a34a" : acc.premium ? "#7c3aed" : acc.confirmed ? "#3B82F6" : "#6b7280",
            color: "#FFFFFF",
            ...
            {acc.popular ? "EXPERT" : acc.premium ? "✦ PREMIUM" : acc.confirmed ? "CONFIRMÉ" : "DÉBUTANT"}
          </div>
        )}

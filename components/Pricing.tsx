    ...
    return (
      <div
        ...
        style={{
          ...
          border: `1px solid ${
            isActive  ? "rgba(184,135,70,0.75)" :
            isHovered ? "rgba(184,135,70,0.28)"  :
          ...
          boxShadow:    isActive
            ? "0 34px 90px rgba(0,0,0,0.88), 0 0 38px rgba(184,135,70,0.22), 0 12px 30px rgba(0,0,0,0.55)"
            : isHovered
              ? "0 32px 80px rgba(0,0,0,0.82), 0 0 20px rgba(184,135,70,0.10), 0 10px 26px rgba(0,0,0,0.50)"
      ...
      >
        ...
        {isActive && (
          <div aria-hidden="true" style={{
            ...
            background: "radial-gradient(circle at 50% 0%, rgba(184,135,70,0.14), transparent 55%)",
          }} />
        )}
        ...
        <div style={{
          ...
          boxShadow: "0 3px 14px rgba(184,135,70,0.32)",
        }}>
          {acc.badge}
        </div>
        ...
        <div style={{
          ...
          <a
            ...
            style={{
              ...
              boxShadow: "0 10px 26px rgba(184,135,70,0.20)",
          ...
          {rows.map((row, ri) => {
            if (row.isPhaseHeader) {
              return (
                <div key={`ph-${ri}`} style={{
                  ...
                  <div style={{ height: 1, flex: 1, background: "rgba(184,135,70,0.18)" }} />
                  <span style={{
                    fontSize: 8, fontWeight: 900, color: "#D4A843",
                    letterSpacing: "2.8px", textTransform: "uppercase",
                  }}>{row.label}</span>
                  <div style={{ height: 1, flex: 1, background: "rgba(184,135,70,0.18)" }} />
                </div>
            ...
            return (
              <button
                ...
                onMouseEnter={event => { if (row.ruleKey) event.currentTarget.style.background = "rgba(184,135,70,.06)"; }}
              ...
              >
                <span style={{ display: "inline-flex", alignItems: "center", gap: 6, color: "rgba(255,255,255,0.48)", fontSize: V(12, 10, 10), fontWeight: 500 }}>
                  {row.label}
                  {row.ruleKey && <i aria-hidden="true" style={{ display: "inline-grid", placeItems: "center", width: 14, height: 14, border: "1px solid rgba(184,135,70,.32)", borderRadius: "50%", color: "#D4A843", fontSize: 8, fontStyle: "normal", fontWeight: 900 }}>i</i>}
                </span>
        ...
        <div style={{
          ...
          background: "rgba(184,135,70,0.055)",
          border: "1px solid rgba(184,135,70,0.14)",
          borderRadius: 10,
          ...
          <span style={{ fontSize: V(11, 10, 11), fontWeight: 800, color: "#D4A843" }}>
            {acc.reward}
          </span>
        </div>
      </div>
    ...
    >
      <style>{`
        .ch-cta:hover {
          ...
          box-shadow: 0 14px 34px rgba(184,135,70,0.34) !important;
        }
        .ch-tog {
          cursor: pointer;
          display: flex;
      ...
      <div style={{ maxWidth: 1420, margin: "0 auto" }}>
        ...
        <div style={{
          ...
          <div style={{
            fontSize: isMobile ? 12 : 12.5, fontWeight: 800, color: "#D4A843",
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    boxShadow:  on ? "0 4px 20px rgba(184,135,70,0.28)" : "none",
                    fontFamily: "inherit",
                  }}
                >
                  <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 8, margin: isMobile ? "-8px 0 18px" : "-5px 0 14px", color: "rgba(255,255,255,.32)", fontSize: isMobile ? 10 : 11 }}>
          <span aria-hidden="true" style={{ display: "grid", placeItems: "center", width: 18, height: 18, borderRadius: "50%", border: "1px solid rgba(184,135,70,.28)", color: "#D4A843", fontSize: 10, fontWeight: 900 }}>i</span>
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: on ? "#D4A843" : "#171717",
                      color: on ? "#000000" : "rgba(255,255,255,0.52)",
                      fontSize: 14, fontWeight: 800,
                      cursor: "pointer", fontFamily: "inherit",
                      transition: "all 0.18s ease",
                      boxShadow: on ? "0 6px 18px rgba(184,135,70,0.30)" : "0 4px 14px rgba(0,0,0,0.40)",
                    }}
                  >
                    {acc.label}
                  </button>

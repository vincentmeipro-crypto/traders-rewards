...
const accounts = [
  { size: "$10,000",  id: "10k",  label: "10K",  price2: "€99",  price1: "€79",  promo2: "€49",  promo1: "€39",  popular: false, premium: false, reward: "~€480"   },
  { size: "$25,000",  id: "25k",  label: "25K",  price2: "€199", price1: "€169", promo2: "€99",  promo1: "€84",  popular: false, premium: false, reward: "~€1,200" },
  { size: "$50,000",  id: "50k",  label: "50K",  price2: "€299", price1: "€249", promo2: "€149", promo1: "€124", popular: false, premium: false, reward: "~€2,400" },
  { size: "$100,000", id: "100k", label: "100K", price2: "€439", price1: "€429", promo2: "€219", promo1: "€214", popular: true,  premium: false, reward: "~€4,800" },
  { size: "$200,000", id: "200k", label: "200K", price2: "€799", price1: "€779", promo2: "€399", promo1: "€389", popular: false, premium: true,  reward: "~€9,600" },
];

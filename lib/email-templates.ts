...
function buildEmail({
  title, body, details, cta, logoUrl,
}: {
  title:      string;
  body:       string;
  ...
  return `
    <div style="background:#f4f4f2;font-family:Helvetica,Arial,sans-serif;padding:48px 16px;color:#111111;">
      <div style="max-width:580px;margin:0 auto;">

        <div style="text-align:center;padding:0 0 28px;">
          <img src="${logoUrl}" alt="Traders Rewards" style="height:52px;max-width:190px;width:auto;display:inline-block;object-fit:contain;" />
        </div>

        <div style="background:#ffffff;border:1px solid #dededb;border-top:3px solid #69C5FD;border-radius:14px;padding:42px 38px;">
          <h2 style="color:#111111;font-size:24px;line-height:1.25;font-weight:750;letter-spacing:-0.35px;margin:0 0 14px 0;">${title}</h2>
          <p style="color:#4b4b48;font-size:15px;line-height:1.75;margin:0 0 30px 0;">${body}</p>
          ...
          <table width="100%" cellPadding="0" cellSpacing="0" style="border-top:1px solid #e8e8e8;margin-bottom:28px;">
            ${details.map(d => `
              <tr>
                ...
                <td style="color:#111111;font-size:14px;font-weight:700;font-family:monospace;padding:12px 0;border-bottom:1px solid #e8e8e8;text-align:right;">${d.value}</td>
              </tr>
            `).join("")}
          </table>

          <a href="${cta.href}" style="display:block;background:#111111;color:#ffffff;text-align:center;padding:16px 24px;border-radius:8px;font-weight:700;text-decoration:none;font-size:15px;letter-spacing:0.1px;">${cta.text}</a>
        </div>

        <div style="margin-top:32px;padding:0 8px;">
          <p style="color:#333333;font-size:14px;font-weight:700;margin:0 0 8px 0;">Besoin d'aide ?</p>
          <p style="color:#777;font-size:13px;line-height:1.6;margin:0 0 20px 0;">
            Contactez-nous à <a href="mailto:contact@traders-rewards.eu" style="color:#111111;text-decoration:none;">contact@traders-rewards.eu</a>
          </p>
  ...
  const html = `
    <div style="background:#f4f4f2;font-family:Helvetica,Arial,sans-serif;padding:48px 16px;color:#111111;">
      <div style="max-width:580px;margin:0 auto;">
        ...
        <div style="background:#ffffff;border:1px solid #dededb;border-radius:14px;overflow:hidden;">
          <div style="background:#0e0e0e;padding:32px 36px 24px;border-bottom:1px solid #1a1a1a;">
            <div style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#d6d6d6;margin-bottom:8px;">Traders Rewards — Certification</div>
            ...
            <div style="font-size:22px;font-weight:700;color:#ffffff;">${name}</div>
          </div>
          <div style="padding:32px 36px;">
            <h2 style="color:#111111;font-size:22px;font-weight:700;margin:0 0 12px 0;">Phase 1 validée — Bravo ${firstName} !</h2>
            ...
            <a href="${certUrl}" style="display:block;background:#111111;color:#ffffff;text-align:center;padding:15px 24px;border-radius:8px;font-weight:700;text-decoration:none;font-size:15px;">Télécharger mon certificat</a>
            ${qrDataUrl ? `
            <div style="text-align:center;margin-top:28px;padding-top:24px;border-top:1px solid #e8e8e8;">
              ...
              <a href="${certUrl}"><img src="${qrDataUrl}" alt="QR Code traçable" style="width:150px;height:150px;display:inline-block;border:1px solid #dededb;border-radius:8px;" /></a>
    ...
    <div style="background:#f4f4f2;font-family:Helvetica,Arial,sans-serif;padding:48px 16px;color:#111111;">
      <div style="max-width:580px;margin:0 auto;">
        ...
        <div style="background:#ffffff;border:1px solid #dededb;border-radius:14px;overflow:hidden;">
          ...
          <div style="padding:32px 36px;">
            <h2 style="color:#111111;font-size:22px;font-weight:700;margin:0 0 12px 0;">Challenge validé — ${firstName}, vous êtes Trader Reward !</h2>
            <p style="color:#444;font-size:15px;line-height:1.7;margin:0 0 20px 0;">
...
export function buildRewardCertificateEmail(p: {
  ...
  const eurRow = netAmountEur != null
    ? `<tr><td style="color:#777;font-size:14px;padding:12px 0;border-bottom:1px solid #e8e8e8;">Équivalent EUR :</td><td style="color:#111111;font-size:15px;font-weight:800;padding:12px 0;border-bottom:1px solid #e8e8e8;text-align:right;">≈ ${netAmountEur.toLocaleString("fr-FR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })} €</td></tr>`
    : "";
  ...
  const html = `
    <div style="background:#f4f4f2;font-family:Helvetica,Arial,sans-serif;padding:48px 16px;color:#111111;">
      <div style="max-width:580px;margin:0 auto;">
        ...
        <div style="background:#ffffff;border:1px solid #dededb;border-radius:14px;overflow:hidden;">
          <div style="background:#0e0e0e;padding:32px 36px 24px;border-bottom:1px solid #1a1a1a;">
            <div style="font-size:11px;font-weight:700;letter-spacing:3px;text-transform:uppercase;color:#d6d6d6;margin-bottom:8px;">Traders Rewards — Versement</div>
          ...
          <div style="padding:32px 36px;">
            <h2 style="color:#111111;font-size:22px;font-weight:700;margin:0 0 12px 0;">Récompense validée — $${netAmount.toLocaleString()} pour vous !</h2>
            <p style="color:#444;font-size:15px;line-height:1.7;margin:0 0 20px 0;">
            ...
            <table width="100%" cellPadding="0" cellSpacing="0" style="border-top:1px solid #e8e8e8;margin-bottom:28px;">
              ...
              <tr><td style="color:#777;font-size:14px;padding:12px 0;border-bottom:1px solid #e8e8e8;">Partage (${splitPct}%) :</td><td style="color:#111111;font-size:16px;font-weight:800;padding:12px 0;border-bottom:1px solid #e8e8e8;text-align:right;">$${netAmount.toLocaleString()}</td></tr>
              ${eurRow}
              <tr><td style="color:#777;font-size:14px;padding:12px 0;">Date :</td><td style="color:#111;font-size:14px;font-weight:700;padding:12px 0;text-align:right;">${date}</td></tr>
            </table>
            <a href="${certUrl}" style="display:block;background:#111111;color:#ffffff;text-align:center;padding:15px 24px;border-radius:8px;font-weight:700;text-decoration:none;font-size:15px;">Télécharger mon certificat</a>

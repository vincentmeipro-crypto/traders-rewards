...
export const t = {
  en: {
    ...
    hero: {
      ...
      sub: 'Pass our challenge and access up to $200,000 in simulated capital. Earn rewards up to 90% of your simulated gains. No personal risk.',
  ...
  fr: {
    ...
    hero: {
      ...
      sub: 'Réussissez notre challenge et accédez à 200 000$ de capital simulé. Gagnez des récompenses jusqu\'à 90% de vos gains simulés. Aucun risque personnel.',
  ...
  ar: {
    ...
    rules: {
      ...
      allowedList: ['جميع الأدوات (فوركس، ذهب، مؤشرات، كريبتو)','التداول الآلي و EA','التداول على الأخبار','الاحتفاظ بالمراكز ليلاً وعطلة نهاية الأسبوع','أزواج عملات متعددة','أي استراتيجية تداول'],
  ...
  es: {
    ...
    rules: {
      ...
      allowedList: ['Todos los instrumentos (Forex, Oro, Índices, Cripto)','Trading algorítmico y EA','Trading en noticias','Posiciones overnight y fin de semana','Múltiples pares de divisas','Cualquier estrategia de trading'],
  ...
  pt: {
    ...
    rules: {
      ...
      allowedList: ['Todos os instrumentos (Forex, Ouro, Índices, Cripto)','Trading algorítmico e EA','Trading em notícias','Posições overnight e fim de semana','Múltiplos pares de moedas','Qualquer estratégia de trading'],
  ...
  de: {
    ...
    rules: {
      ...
      allowedList: ['Alle Instrumente (Forex, Gold, Indizes, Krypto)','Algorithmischer Handel & EA','News-Trading','Overnight- und Wochenendhaltung','Mehrere Währungspaare','Jede Handelsstrategie'],
  ...
  tr: {
    ...
    rules: {
      ...
      allowedList: ['Tüm enstrümanlar (Forex, Altın, Endeksler, Kripto)','Algoritmik & EA işlem','Haber işlemi','Gecelik & hafta sonu pozisyon','Birden fazla döviz çifti','Her türlü işlem stratejisi'],
